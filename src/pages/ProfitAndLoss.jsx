...
const ProfitAndLoss = () => {
  ...
  // Manually set the sales data for testing
  useEffect(() => {
    const sampleSalesData = [
      { category: 'Electronics', amount: 1000.00, date: '2024-09-01', commission: 50.00 },
      { category: 'Furniture', amount: 2000.00, date: '2024-09-03', commission: 100.00 },
      { category: 'Clothing', amount: 1500.00, date: '2024-09-05', commission: 75.00 },
      { category: 'Books', amount: 500.00, date: '2024-09-10', commission: 25.00 }
    ];
